    ...
    <div class="col-12 card-body">
        ...
        <div class="row mb-2">
            ...
            <div class="col-5 col-md-7 text-end">
                <a href="{{ route('department.create') }}" class="btn btn-primary btn-rounded bs-tooltip" data-toggle="tooltip"
                data-placement="top" title="" data-bs-original-title="Add new ">
                    ...
                    <span class="btn-text-inner">Add a Department</span>
                </a>
            </div>
        </div>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="action-btns">
                                    ...
                                    <a onclick="javascript:if(confirm('Are you sure you want to delete this record: {{ $department->name }}?')){document.form{{ $department->id }}.submit()}"
                                    ...
                                    <form action="{{ route('department.destroy', $department->id) }}" method="POST"
                                        ...
                                        onSubmit="return confirm('Are you want to Delete this Department sure?')">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </div>
